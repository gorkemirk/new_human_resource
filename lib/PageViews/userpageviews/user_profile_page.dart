...
class UserProfilePageView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<UserProfilePageView> createState() =>
      _UserProfilePageViewState();
}

class _UserProfilePageViewState extends ConsumerState<UserProfilePageView> {
                      ...
                      ElevatedButton(
                          onPressed: () async {
                            if (_formKey.currentState!.validate()) {
                              ...
                              var isUpdatePass = await widget
                                  .authenticationService
                                  .updatePassword(newPassword: _newPassword);
                              // ignore: use_build_context_synchronously
                              if (isUpdatePass) {
                                await widget.authenticationService.userLogOut();
